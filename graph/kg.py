...
from retreiver import CustomRetriever
...
class Knowledge_Base:
    ...
    def create_knowledge_graph(self, file_path: str, knowledge_base_name: str) -> None:
    ...
    def load_knowledge_graph(self, knowledge_base_name: str) -> bool:
        with open("data.json", "r") as jsonFile:
            data = json.load(jsonFile)
